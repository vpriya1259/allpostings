...
public class LocalFileStorage implements FileStorage {
    ...
    * 
    * @param storageUrl
    *           the logical URL pointing to the root of this file storage
    * @param storageDirectory
    *           the path to the base directory on the filesystem where files
    *           physically reside; created if necessary.
    */
    ...
    * when the VM shuts down. Useful for temporary file stores. Defaults to
    * false.
    */
...
/*   public List<Long> getPostingImages(String fileName) {
      File dir = new File(storageDirectory, fileName);
      if (!dir.isDirectory()) {
         return null;
      }
      ...
      File [] files = dir.listFiles(new FilenameFilter() {
         ...
         public boolean accept(File dir, String name) {
            return name.endsWith("-normal.jpg");
         }
      });
