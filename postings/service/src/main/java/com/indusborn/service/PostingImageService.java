 ...
 * @author Craig Walls
 */
public interface PostingImageService {
	 ...
	 */
	void savePostingImage(Long postingId, Long postingImageId, byte[] imageBytes) throws IOException;
	
	void delPostingImage(Long postingId, Long postingImageId);
